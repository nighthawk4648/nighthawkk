      ...
      <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
        ...
        <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-lg mb-12 text-gray-400 max-w-2xl mx-auto leading-relaxed">
            Access thousands of high-quality 3D models, textures, and assets
            directly inside SketchUp. Transform your workflow with our
            comprehensive free library.
          </p>
          <button
          ...
          <p className="mt-2 font-bold text-gray-200">
            ...
            <span className="text-cyan-400">
              {DOWNLOAD_COUNT_BASELINE + (downloadData?.data?.count || 0)}
            </span>{" "}
            times
          </p>
        </div>
      ...
      <div className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of designers who trust SketchShaper for their 3D
            asset needs.
          </p>
          <button
            onClick={handleDownload}
