      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {blogs?.map((blog) => (
            <div
              key={blog?.id}
              className="bg-gray-800 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-700"
            >
              {/* Blog Image */}
              {blog?.image && (
                <Link
                ...
                >
                  <div className="relative h-48 overflow-hidden cursor-pointer group">
                    <Image
                      ...
                      alt={
                        blog?.image_alt?.trim() || blog?.title || "Blog image"
                      }
                      width={500}
                      height={300}
