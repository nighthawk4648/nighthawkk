  ...
  useEffect(() => {
    ...
    if (errorParam) {
      ...
      if (errorParam === "not_patron") {
        ...
        details = message
          ? decodeURIComponent(message)
          : "Could not retrieve your Patreon information. Please try again.";
        redirectDelay = 8000;
      } else if (message) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-black">
        <div className="text-center bg-red-900/20 border border-red-500 rounded-lg p-8 max-w-md">
          ...
          {errorDetails && (
            <p className="text-gray-300 mb-6 leading-relaxed whitespace-pre-wrap text-left">
              {errorDetails}
            </p>
          )}
          <div className="mt-6 space-y-3">
            ...
            <div className="p-4 bg-red-500/10 rounded border border-red-500/30">
              <p className="text-sm text-gray-400">
                ...
                <span className="font-bold text-red-400">{countdown}</span>{" "}
                seconds...
              </p>
            </div>
            <button
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-black">
      <div className="text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <div
            className="w-2 h-2 bg-[#FF424D] rounded-full animate-bounce"
