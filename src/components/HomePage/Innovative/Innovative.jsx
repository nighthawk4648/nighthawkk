    ...
    return (
        <div className='relative'>
            ...
            <div className='absolute right-[180px] top-[150px] md:top-1/2 '>
                <Link href={`${innovatives?.urlOne ? innovatives?.urlOne : '/'}`} ><AiFillPlusCircle className='text-orange-700 text-2xl md:text-4xl' /></Link>
            </div>

            <div className='absolute right-[100px] md:right-[200px] lg:right-[500px] top-1/2 md:top-3/4 '>
                <Link  href={`${innovatives?.urlTwo ? innovatives?.urlTwo : '/'}`} ><AiFillPlusCircle className='text-orange-700 text-2xl md:text-4xl' /></Link>
            </div>

            <div className='absolute left-[40px] md:left-[100px] lg:left-[130px] top-[60px] md:top-[170px] '>
                <Link href={`${innovatives?.urlThree ? innovatives?.urlThree : '/'}`} ><AiFillPlusCircle className='text-orange-700 text-2xl md:text-4xl' /></Link>
            </div>

            <div className='absolute left-[100px] md:left-[300px] top-3/4 '>
                <Link href={`${ innovatives?.urlFour ? innovatives?.urlFour : '/'}`}><AiFillPlusCircle className='text-orange-700 text-2xl md:text-4xl' /></Link>
            </div>
        </div>
    );
};
