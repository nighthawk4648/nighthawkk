          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                sketch shaper Is a library of 1000+ textures and 3d sketchup
                assets crafted by experts.
              </p>
            ...
            <div>
              ...
              <div className="space-y-3">
                {footerPages?.map((footerPage) => {
                  ...
                  const href =
                    customRoutes[footerPage.slug] ||
                    `/pages/${footerPage.slug}-${footerPage.id}`;
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-300">
                  <div className="text-blue-400">{icons.email}</div>
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center space-x-4 mb-8">
              {socials?.map((social) => {
                if (!social?.url) return null;
                return (
                  <Link key={social?.id} href={social?.url} className="group">
